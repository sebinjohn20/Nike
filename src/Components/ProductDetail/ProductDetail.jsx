...
const smallImg=[
  "https://static.nike.com/a/images/t_default/654141ae-1e26-429d-b644-52b25052fc8c/AIR+FORCE+1+%2707+LV8.png",
  "https://static.nike.com/a/images/t_default/315ec9a2-d617-42fd-b114-1fb7be184926/AIR+FORCE+1+%2707+LV8.png",
  "https://static.nike.com/a/images/t_default/3bd647da-ac9d-44d4-938b-eab787b7f31a/AIR+FORCE+1+%2707+LV8.png",
  "https://static.nike.com/a/images/t_default/b3c2bca4-c031-480b-abee-176469fec336/AIR+FORCE+1+%2707+LV8.png",
  "https://static.nike.com/a/images/t_default/04034f7b-766b-41be-8f2f-b0b9757de11a/AIR+FORCE+1+%2707+LV8.png",

  "https://static.nike.com/a/images/t_default/60329ca0-74fe-4027-aec8-f9b125f35489/AIR+FORCE+1+%2707+LV8.png",
  "https://static.nike.com/a/images/t_default/bd3025b0-acf2-4d18-b6bf-996f45545787/AIR+FORCE+1+%2707+LV8.png",
...
const handlePrev=()=>{
 ...
 <>
  <main>
      ...
      <div className="product-detalis-desktop-container">
        <div className="grid-item-product-imagerty">
                  <div className="desktop-image-carousel-container">
                    ...
                    <div className="desktop-product-large-img-container">
                      <div className="desktop-product-large-img-high-rated">
                        <svg aria-hidden="true" focusable="false" viewBox="0 0 24 24" role="img" width="20px" height="20px" fill="none"><path fill="currentColor" fill-rule="evenodd" stroke="currentColor" stroke-width="1.5" d="M2.56 10.346l5.12 3.694-1.955 5.978c-.225.688.568 1.261 1.157.836L12 17.159l5.12 3.695c.587.425 1.381-.148 1.155-.836l-1.954-5.978 5.118-3.694c.589-.425.286-1.352-.442-1.352H14.67l-.166-.507-1.789-5.47c-.225-.69-1.205-.69-1.43 0L9.33 8.993H3.003c-.728 0-1.03.927-.442 1.352z" clip-rule="evenodd"></path></svg>
        ...
        <div className="desktop-product-info-wrapper">
          <h1>Nike Air Force 1 '07 LV8</h1>
          <h2>Men's Shoes</h2>
        </div>
         <div className="grid-item-price-container">
