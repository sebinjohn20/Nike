  ...
  return (
    <div>
      <div className="top-bar-container">
        <div className="top-bar-container-grid">
      ...
      <div className="header-container">
        ...
        <nav>
          <ul className="desktop-category">
            <li>
              <div className="desktop-category-item">
                New & Featured
              </div>
             <div style={{width:'12px',height:'24px'}}></div>
            ...
            <li>
              <div className="desktop-category-item standalone-link">
               SNKRS
              </div>
        ...
        <div className="header-right-side-container">
            <div className="header-right-side-body">
              <div className="search-item-desktop-container">
                ...
                <button className='faviourte-btn'>
                ...
                <button className='profile-btn one'>
