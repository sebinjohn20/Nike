  ...
  return (
    <div>
      ...
      <footer className="dekstop-footer">
        <div className="desktop-footer-top-border">

        </div>
        <div className="desktop-footer-menu">
            <div className="desktop-footer-menu-column">
                        <h2>Resources</h2>
                        <p>Find A Store</p>
                        <p>Become A Member</p>
                        <p>Running Shoe Finder </p>
            ...
            <div className="desktop-country-footer">
                <span className='globe-icon-span'>
        ...
        <div className="footer-desktop-space-bottom">

        </div>
        <div className="footer-desktop-bottom-container">
            <ul>
                <li className="footer-copy-right">
           <span>© 2025 Nike, Inc. All rights reserved</span>
                </li>
